...
function load(app) {
  ...
  app.renderer.hooks.on("head.begin", (ctx) => {
    ...
    ), /* @__PURE__ */ import_typedoc.JSX.createElement("meta", { name: "web-author", content: "Okiki Ojo" }), /* @__PURE__ */ import_typedoc.JSX.createElement("meta", { name: "robots", content: "index, follow" }), /* @__PURE__ */ import_typedoc.JSX.createElement("meta", { name: "twitter:url", content: "https://sharedworker.okikio.dev" }), /* @__PURE__ */ import_typedoc.JSX.createElement("meta", { name: "twitter:site", content: "@okikio_dev" }), /* @__PURE__ */ import_typedoc.JSX.createElement("meta", { name: "twitter:creator", content: "@okikio_dev" }), /* @__PURE__ */ import_typedoc.JSX.createElement("link", { href: "https://twitter.com/okikio_dev", rel: "me" }), /* @__PURE__ */ import_typedoc.JSX.createElement(
      "link",
      {
        rel: "webmention",
